...
LARGE_DOCUMENT_THRESHOLD_PAGES = 100
LARGE_DOCUMENT_CHUNK_SIZE = 50
LARGE_DOCUMENT_MAX_PARAGRAPHS = 500
LARGE_DOCUMENT_MAX_TABLES = 50



# Modèles RAG Hugging Face
RAG_MODEL_NAME = config('RAG_MODEL_NAME', default='facebook/rag-sequence-nq')
RAG_RETRIEVER_NAME = config('RAG_RETRIEVER_NAME', default='facebook/dpr-ctx_encoder-single-nq-base')

# Paramètres de génération
RAG_MAX_NEW_TOKENS = int(config('RAG_MAX_NEW_TOKENS', default='100'))
RAG_USE_GPU = config('RAG_USE_GPU', default='True', cast=bool)
RAG_USE_DUMMY_DATASET = config('RAG_USE_DUMMY_DATASET', default='True', cast=bool)
RAG_USE_CUSTOM_RETRIEVER = config('RAG_USE_CUSTOM_RETRIEVER', default='True', cast=bool)

RAG_MODEL_CACHE_DIR = config('RAG_MODEL_CACHE_DIR', default='')

# Timeouts pour les requêtes RAG
RAG_REQUEST_TIMEOUT = int(config('RAG_REQUEST_TIMEOUT', default='300'))  # 5 minutes
RAG_GENERATION_TIMEOUT = int(config('RAG_GENERATION_TIMEOUT', default='60'))  # 1 minute
