# Generated by Django 5.2.4 on 2025-09-08 00:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tables', to='doctrine.section', verbose_name='Section')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='table',
            index=models.Index(fields=['order_index'], name='doctrine_ta_order_i_75b701_idx'),
        ),
        migrations.AddIndex(
            model_name='table',
            index=models.Index(fields=['table_type'], name='doctrine_ta_table_t_3b2c5b_idx'),
        ),
        migrations.AddIndex(
            model_name='theme',
